<template>
  <div class="navbar mt-0 md:mt-8 lg:px-10 [&_span]:lg:block [&_span]:hidden">
    <div class="navbar-start">
      <button class="hidden space-x-0 md:flex btn btn-ghost lg:space-x-2">
        <font-awesome-icon icon="fas fa-question-circle" />
        <span class="hidden lg:block"> Help & FAQ </span>
      </button>
      <div class="hidden p-4 lg:block">
        <input type="text" placeholder="Search for products" class="w-full p-4 input input-bordered input-primary" />
      </div>
      <button class="block space-x-0 lg:space-x-2 btn btn-ghost lg:hidden" @click="$vfm.show('searchModal')">
        <span> Search </span>
    ...
    <div class="navbar-end [&_label]:lg:space-x-2 [&>*]:space-x-0 space-x-2">
      <div class="hidden dropdown dropdown-bottom dropdown-end md:block">
        <label tabindex="0" class="btn btn-ghost">
          <span> Cart </span>
          <font-awesome-icon icon="fas fa-cart-shopping" />
        </label>
        <div tabindex="0"
          class="w-64 p-2 shadow translate-x-1/4 dropdown-content card card-compact bg-primary text-primary-content">
          <div class="card-body">
            <h3 class="card-title">Number of Items:</h3>
            <p>you can use any element as a dropdown.</p>
          </div>
        </div>
      </div>
      <div tabindex="0" class="dropdown dropdown-bottom dropdown-end">
  ...
  <vue-final-modal v-model="show" name="searchModal" classes="flex justify-center items-center"
    content-class="w-[80%] md:w-[50%]">
    <div class="p-4">
      <input type="text" placeholder="Search for products" class="w-full p-4 input input-bordered input-primary" />
    </div>
  </vue-final-modal>
